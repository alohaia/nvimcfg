...
if str2nr(vimwiki#vars#get_global('key_mappings').links)
  ...
  call vimwiki#u#map_key('n', '<C-G>s', '<Plug>VimwikiSplitLink')
  call vimwiki#u#map_key('n', '<C-G>v', '<Plug>VimwikiVSplitLink')
  ...
  call vimwiki#u#map_key('n', '<C-G>t', '<Plug>VimwikiTabnewLink')
  call vimwiki#u#map_key('n', '<C-G>T', '<Plug>VimwikiTabnewLink', 1) " 有什么不同吗？
...
if str2nr(vimwiki#vars#get_global('key_mappings').lists)
  ...
  call vimwiki#u#map_key('n', '<leader>ck', '<Plug>VimwikiToggleListItem')
  call vimwiki#u#map_key('v', '<leader>ck', '<Plug>VimwikiToggleListItem', 1)
  if has('unix')
