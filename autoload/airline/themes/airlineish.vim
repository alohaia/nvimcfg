...
let s:N3 = [ '#ffffff' , 'NONE'    , 15 , 233 ]

" Insert mode
let s:I1 = [ '#ffffff' , '#005fff' , 15 , 33  ]
let s:I2 = [ '#ffffff' , '#00afff' , 15 , 39  ]
let s:I3 = [ '#ffffff' , 'NONE'    , 15 , 233 ]

" Visual mode
let s:V1 = [ 'NONE'    , '#ff5f00' , 233 , 202 ]
let s:V2 = [ 'NONE'    , '#ffaf00' , 233 , 214 ]
let s:V3 = [ '#ffffff' , 'NONE'    , 15  , 233 ]

" Replace mode
let s:R1 = [ '#ffffff' , '#ff0000' , 15 , 196 ]
let s:R2 = [ '#ffffff' , '#ff5f5f' , 15 , 203 ]
let s:R3 = [ '#ffffff' , 'NONE'    , 15 , 233 ]
...
let g:airline#themes#airlineish#palette.tabline = {
      ...
      \ 'airline_tabfill': [ '#ffffff' , 'NONE'    ,  15 , 233 , '' ],
